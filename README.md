...
**Práctica Formativa Obligatoria 2** — Instituto de Formación Técnica Superior (IFTS)

> **Consigna:** Diseñar y estructurar un único prompt inicial de alta precisión para generar una Landing Page, ejecutándolo en dos agentes de desarrollo de software distintos para comparar su capacidad de resolución autónoma.
...
> **[Ver sitio en Vercel](https://ifts-29-frontend-pfo-2.vercel.app)**

El proyecto despliega una **portada de acceso** que contiene tres enlaces directos:

1. **Prompt utilizado** — Texto plano del prompt exacto.
2. **Landing Page — OpenCode (deepseek-v4-flash-free)** — Generada por el primer agente.
3. **Landing Page — Codex (OpenAI / gpt-5.5)** — Generada por el segundo agente.
...
| **Archivo**        | [`opencode/index.html`](opencode/index.html) |
...
| **Agente**         | Codex (OpenAI)                    |
| **Modelo**         | gpt-5.5                           |
| **Archivo**        | [`codex/index.html`](codex/index.html) |
...
El prompt fue diseñado siguiendo las guías oficiales de **Anthropic Prompt Engineering Guide** y **OpenAI Prompt Engineering Guide**, aplicando las siguientes técnicas:

## TÉCNICAS APLICADAS

| Técnica | Fuente | Implementación |
|---|---|---|
| Role prompting | Anthropic | Bloque `<rol>` con perfil experto específico |
...
### Landing Page — OpenCode (deepseek-v4-flash-free)

| Sección | Vista Previa |
|---------|-------------|
| Header + Hero | ![Header + Hero](screenshots/opencode-hero.webp) |
| Sobre Nosotros | ![Sobre Nosotros](screenshots/opencode-acerca.webp) |
| Servicios | ![Servicios](screenshots/opencode-servicios.webp) |
| Testimonios | ![Testimonios](screenshots/opencode-testimonios.webp) |
| Formulario de Contacto | ![Contacto](screenshots/opencode-contacto.webp) |
| Footer | ![Footer](screenshots/opencode-footer.webp) |

### Landing Page — Codex (OpenAI / gpt-5.5)

| Sección | Vista Previa |
|---------|-------------|
| Header + Hero | ![Header + Hero](screenshots/codex-hero.webp) |
| Sobre Nosotros | ![Sobre Nosotros](screenshots/codex-acerca.webp) |
| Servicios | ![Servicios](screenshots/codex-servicios.webp) |
| Testimonios | ![Testimonios](screenshots/codex-testimonios.webp) |
| Formulario de Contacto | ![Contacto](screenshots/codex-contacto.webp) |
| Footer | ![Footer](screenshots/codex-footer.webp) |
...
1. **Diseño del Prompt** — Se investigaron las guías oficiales de Anthropic y OpenAI para diseñar un prompt estructurado con etiquetas XML, role prompting y subtareas secuenciadas.
2. **Ejecución en OpenCode** — El prompt se ejecutó en OpenCode usando el modelo `deepseek-v4-flash-free`, generando una landing page completa para "Nómada Viajes".
3. **Restricción estricta** — No se modificó código de forma manual en ninguna de las ejecuciones, permitiendo que el agente actúe de forma autónoma.
4. **Ejecución en Codex (gpt-5.5)** — El mismo prompt se ejecutó en Codex (OpenAI) con el modelo **gpt-5.5**, generando la landing page de "Nómada Viajes" para comparar resultados.
